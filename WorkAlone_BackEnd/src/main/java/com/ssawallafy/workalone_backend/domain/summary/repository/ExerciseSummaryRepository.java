...
public interface ExerciseSummaryRepository extends JpaRepository<ExerciseSummary, Long> {
	...
	@Query("SELECT new com.ssawallafy.workalone_backend.domain.summary.dto.ExerciseSummaryDetail(e.exerciseGroup.id, e.seq, t.title, e.exerciseSet, e.exerciseRepeat, s.time, s.kcal, s.video_url) "
