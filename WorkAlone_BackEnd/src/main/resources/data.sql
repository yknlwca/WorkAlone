INSERT INTO workalone.exercise_info (title, sub_title, basic_pose, movement, breath, exercise_type)
...
INSERT INTO workalone.member (name, nickname, email, phone_number, gender, is_trainer, height, weight)
VALUES ('John Doe', 'johnd', 'johndoe@example.com', '123-456-7890', true, false, 180, 75);

INSERT INTO workalone.exercise (member_id, title, rest_time, exercise_set, set_detail, exercise_type, set_type, deleted)
